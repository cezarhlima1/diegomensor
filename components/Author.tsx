    ...
    <section className="py-[72px] md:py-24">
      <div className="wrap">
        <div className="author-card reveal grid grid-cols-1 lg:grid-cols-[.85fr_1.15fr]">
          {/* foto placeholder do Diego */}
          <div className="author-photo relative min-h-[280px] lg:min-h-[380px] border-b lg:border-b-0 lg:border-r border-blue/20">
            <div className="ph">
              <div className="ph-label">
                <User className="w-10 h-10 mx-auto mb-2.5" />
                Foto do Diego
                <br />
                na oficina
              </div>
